describe('Unit : vimeoPlugin Widget Enums', function () {

  var TAG_NAMES, STATUS_CODE, STATUS_MESSAGES, CONTENT_TYPE, LAYOUTS, VIDEO_COUNT, VIMEO_KEYS;

  beforeEach(module('vimeoPluginWidget'));

  beforeEach(inject(function (_TAG_NAMES_, _STATUS_CODE_, _STATUS_MESSAGES_, _CONTENT_TYPE_, _VIMEO_KEYS_, _VIDEO_COUNT_, _LAYOUTS_) {
  ...
  describe('Unit : Enum VIMEO_KEYS', function () {
    ...
    it('VIMEO_KEYS.ACCESS_TOKEN should exist and equals to "8e73ca420b7b386f936eaa5a0eb24e39"', function () {
      expect(VIMEO_KEYS.ACCESS_TOKEN).toEqual('8e73ca420b7b386f936eaa5a0eb24e39');
    });
  });

  describe('Unit : Enum VIDEO_COUNT', function () {
