describe('Unit : vimeoPlugin design.home.controller.js', function () {
  var $scope, DesignHome, $rootScope, q, $controller, DataStore, ImageLibrary, _mockData, TAG_NAMES, LAYOUTS, STATUS_CODE, STATUS_MESSAGES, CONTENT_TYPE;
  beforeEach(module('vimeoPluginDesign'));

  beforeEach(inject(function (_$rootScope_, _$q_, _$controller_, _DataStore_, _ImageLibrary_, _LAYOUTS_, _TAG_NAMES_, _CONTENT_TYPE_, _STATUS_CODE_, _STATUS_MESSAGES_) {
  ...
  describe('Units: units should be Defined', function () {
    ...
    it('it should pass if DesignHome.masterData match the object', function () {
  ...
  describe('Function :DesignHome.changeListLayout', function () {
    ...
    it('it should pass if DesignHome.data.design.itemListLayout is equals to "List_Layout_3" after passing parameter "List_Layout_4" to DesignHome.changeListLayout', function () {
